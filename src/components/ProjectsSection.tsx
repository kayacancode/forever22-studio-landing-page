  ...
  const projects = [
    {
      ...
      image: '/images/thryvelogo.png', // placeholder image
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-16'>
          ...
          >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Explore our current and past partners that we've built from the
              ground into thriving online communities.
            </motion.p>
          </motion.div>
        ...
        >
          <div className='overflow-hidden'>
            ...
            >
              {projects.map((project, index) => (
                ...
                >
                  <div className='bg-gray-800 rounded-2xl lg:rounded-3xl overflow-hidden group'>
                    {/* Project Image */}
                    ...
                    >
                      <div className='space-y-2'>
                        <div className='text-xs text-orange-400 font-medium uppercase tracking-wider'>
                          {project.category}
                        </div>
                        <h3 className='text-lg sm:text-xl font-bold text-white group-hover:text-orange-400 transition-colors duration-300 leading-tight'>
                          {project.title}
                        </h3>
                      </div>
                      ...
                      <Link href={`/work/${project.id}`}>
                        <motion.div
                          className='text-orange-500 hover:text-orange-400 text-sm font-medium flex items-center group/btn mt-4 cursor-pointer'
                          whileHover={{ x: 5 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          Learn more
          ...
          >
            <motion.button
              onClick={prevSlide}
              className='w-10 h-10 sm:w-12 sm:h-12 bg-gray-800 hover:bg-gray-700 rounded-full flex items-center justify-center text-white transition-colors duration-200 group'
